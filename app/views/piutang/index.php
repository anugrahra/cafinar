<div class="row">
  <div class="col">
    <h3>PIUTANG <span class="text-primary">(Rp .<?= number_format($data['total']['total']); ?>)</span></h3>
  </div>
...
<div class="row">
  ...
  <div class="col d-flex justify-content-end">
    <form class="form-inline" method="POST" action="<?= BASEURL; ?>/piutang/index">
