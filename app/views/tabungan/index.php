<div class="row">
  <div class="col">
    <h3>TABUNGAN <span class="text-info">(Rp. <?= number_format($data['total']['total']); ?>)</span></h3>
  </div>
...
<div class="row">
  ...
  <div class="col d-flex justify-content-end">
    <form class="form-inline" method="POST" action="<?= BASEURL; ?>/tabungan/index">
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><?= number_format($tabungan['nabung']); ?></td>
            <td><?= number_format($tabungan['narik']); ?></td>
